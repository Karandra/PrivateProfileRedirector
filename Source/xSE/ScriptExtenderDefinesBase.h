...
#define xSE_RUNTIME_VERSION CURRENT_RELEASE_RUNTIME
...
#define xSE_PACKED_VERSION PACKED_SKSE_VERSION
#if xSE_PLATFORM_GOG
	#define xSE_CONFIG_FOLDER_NAME Skyrim Special Edition GOG
	#define xSE_RUNTIME_VERSION RUNTIME_VERSION_1_6_1179_GOG
#else
	#define xSE_CONFIG_FOLDER_NAME Skyrim Special Edition
	#define xSE_RUNTIME_VERSION CURRENT_RELEASE_RUNTIME
#endif
